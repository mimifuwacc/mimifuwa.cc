      ...
      <CardContent>
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            size="sm"
            variant="secondary"
            render={<a href="https://github.com/mimifuwacc" target="_blank" rel="noopener noreferrer" aria-label="GitHub" />}
          >
            <FaGithub /> GitHub
          </Button>
          <Button
            size="sm"
            variant="secondary"
            render={<a href="https://twitter.com/mimifuwacc" target="_blank" rel="noopener noreferrer" aria-label="Twitter" />}
          >
            <FaTwitter /> Twitter
          </Button>
          <Button
            size="sm"
            variant="secondary"
            render={<a href="https://zenn.dev/mimifuwacc" target="_blank" rel="noopener noreferrer" aria-label="Zenn" />}
        ...
        <div className="relative">
          ...
          {timelineData.map((event) => (
            <div
              ...
              className="relative pl-6 pb-7 last:pb-8"
            >
