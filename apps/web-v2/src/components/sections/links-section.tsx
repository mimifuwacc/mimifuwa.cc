...
export function LinkToPage({ link }: { link: LinkItem }) {
  return (
    <Card
      variant="hover"
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1 text-sm text-slate-500">
            ...
            <FaExternalLinkAlt className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-all duration-200" />
          </div>
        </div>
      </div>
...
export default function LinksSection() {
  ...
  return (
    <Section id="links-section" title="Links" subtitle="知り合いのオタクのサイトたちです">
