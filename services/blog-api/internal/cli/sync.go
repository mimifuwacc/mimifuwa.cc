...
import (
	...
	"github.com/mimifuwacc/blog-api/internal/infra/cloudflare"
	"github.com/mimifuwacc/blog-api/internal/infra/local"
	"github.com/mimifuwacc/blog-api/internal/repository"
	"github.com/mimifuwacc/blog-api/internal/usecase"
...
func runSync(all, remote, verbose bool) error {
	...
	if remote {
		...
		r2Client = local.NewWranglerR2Client(cfg.R2BucketName)
		d1 := local.NewWranglerD1Client("mimifuwacc-blogs")
		blogPost = d1
		tagRepo = d1
	}

	gitClient := local.NewGitClient(cfg.WorkDir)
...
func runList(remote bool) error {
	...
	if remote {
		...
		blogPost = local.NewWranglerD1Client("mimifuwacc-blogs")
	}
